...
public class AutoConfiguration {
    ...
    public EmbeddingClient embeddingClient(EmbeddingProperties embeddingProperties) {
        ...
        EmbeddingClient.Builder builder = EmbeddingClient.builder()
                .baseUrl(embeddingProperties.getBaseUrl())
                .model(embeddingProperties.getModel())
                .openAiApiKey(embeddingProperties.getApiKey())
                .logRequests(embeddingProperties.isLogRequests())
                .logResponses(embeddingProperties.isLogResponses());
